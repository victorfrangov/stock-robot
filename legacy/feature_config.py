...
class FeatureConfig:
    ...
    def load_data(self) -> None:
        ...
        self.ohlcv_df = pd.read_excel(f'historical_data/xlsx/{self.ticker}.xlsx')
    ...
    def create_features(self, ticker: str) -> pd.DataFrame:
        ...
        factor_4h = 16
        macd_line_4h, macd_signal_4h, macd_hist_4h = talib.MACD(close, 12*factor_4h, 26*factor_4h, 9*factor_4h)
        
        features['MACD_15m'], features['MACD_Signal_15m'], features['MACD_Histogram_15m'] = macd_line_15m, macd_signal_15m, macd_hist_15m
        features['MACD_4h'], features['MACD_Signal_4h'], features['MACD_Histogram_4h'] = macd_line_4h, macd_signal_4h, macd_hist_4h
        ...
        # features['MACD_Position_4h'] = (features['MACD_4h'] > features['MACD_Signal_4h']).astype(int)
